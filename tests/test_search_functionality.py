...
class TestSearchFunctionality(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_recommender.genre_tree.tracks = {
            'track1': Mock(data={'track_name': 'Shape of You', 'artist_name': 'Ed Sheeran'}),
            'track2': Mock(data={'track_name': 'Blinding Lights', 'artist_name': 'The Weeknd'}),
            'track3': Mock(data={'track_name': 'Watermelon Sugar', 'artist_name': 'Harry Styles'}),
            'track4': Mock(data={'track_name': 'Don\'t Start Now', 'artist_name': 'Dua Lipa'}),
            'track5': Mock(data={'track_name': 'Levitating', 'artist_name': 'Dua Lipa'}),
        }
