...
from src.musicrec.main import main, create_sample_data, load_data
...
class TestEndToEndSampleDataFlow:
    ...
    def test_create_sample_data_integration(self):
        ...
        required_columns = ['track_id', 'genre_hierarchy', 'mood_tags', 'energy', 'valence', 'tempo']
    ...
    def test_recommendation_engine_with_sample_data(self):
        ...
        if len(df) > 0:
            ...
            similar_tracks = recommender.recommend_similar_to_track(first_track_id, limit=3)
...
class TestDataProcessingIntegration:
    ...
    def test_sample_data_to_recommender_pipeline(self):
        ...
        df = create_sample_data(num_genres=num_genres, tracks_per_genre=tracks_per_genre)
        ...
        for genre in available_genres:
            ...
            for rec in genre_recs:
                ...
                assert any(genre.lower() in str(path_part).lower() for path_part in genre_path)
    ...
    def test_configuration_integration(self):
        ...
        from src.musicrec.config.settings import load_config, get_data_paths
