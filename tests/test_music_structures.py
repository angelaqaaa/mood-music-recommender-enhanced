...
from src.musicrec.music_structures import MusicNode, GenreTree, SimilaritySongGraph
...
class TestGenreTree:
    ...
    def test_search_by_mood_existing(self):
        ...
        tree = GenreTree()
        tree.add_track('track_1', ['rock'], {'artist': 'Artist 1', 'mood_tags': ['happy', 'energetic']})
        tree.add_track('track_2', ['pop'], {'artist': 'Artist 2', 'mood_tags': ['happy']})
        tree.add_track('track_3', ['rock'], {'artist': 'Artist 3', 'mood_tags': ['sad']})
    ...
    def test_search_by_mood_nonexistent(self):
        ...
        tree = GenreTree()
        tree.add_track('track_1', ['rock'], {'artist': 'Artist 1', 'mood_tags': ['happy']})
    ...
    def test_search_by_genre_and_mood(self):
        ...
        tree = GenreTree()
        tree.add_track('track_1', ['rock'], {'artist': 'Artist 1', 'mood_tags': ['happy']})
        tree.add_track('track_2', ['rock'], {'artist': 'Artist 2', 'mood_tags': ['sad']})
        tree.add_track('track_3', ['pop'], {'artist': 'Artist 3', 'mood_tags': ['happy']})
...
class TestSimilaritySongGraph:
    ...
    def test_calculate_similarities(self):
        ...
        graph.add_node('track_1', {'energy': 0.8, 'valence': 0.7, 'mood_tags': ['happy']})
        graph.add_node('track_2', {'energy': 0.9, 'valence': 0.8, 'mood_tags': ['energetic']})
        graph.add_node('track_3', {'energy': 0.2, 'valence': 0.3, 'mood_tags': ['sad']})
        
        graph.calculate_similarities(['energy', 'valence'], mood_weight=0.5, feature_weight=0.5)
...
class TestEdgeCasesAndErrorHandling:
    ...
    def test_genre_tree_duplicate_track(self):
        ...
        tree.add_track('track_1', ['rock'], {'artist': 'Artist 1'})
        tree.add_track('track_1', ['pop'], {'artist': 'Artist 2'})  # Same ID, different data
