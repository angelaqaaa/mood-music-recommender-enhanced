...
from src.musicrec.music_structures import GenreTree, SimilaritySongGraph, MusicNode
...
class TestRecommendByGenreAndMood:
    ...
    def test_recommend_by_genre_and_mood_existing(self, music_recommender):
        ...
        recommendations = music_recommender.recommend_by_genre_and_mood('rock', 'happy', limit=5)
    ...
    def test_recommend_by_genre_and_mood_no_match(self, music_recommender):
        ...
        recommendations = music_recommender.recommend_by_genre_and_mood('rock', 'party', limit=5)
...
class TestRecommendSimilarToTrack:
    ...
    def test_recommend_similar_to_track_existing(self, music_recommender):
        ...
        recommendations = music_recommender.recommend_similar_to_track('track_1', limit=3)
    ...
    def test_recommend_similar_to_track_nonexistent(self, music_recommender):
        ...
        recommendations = music_recommender.recommend_similar_to_track('nonexistent_track', limit=3)
...
class TestBFSRecommend:
    ...
    def test_bfs_recommend_with_mood(self, music_recommender):
        ...
        recommendations = music_recommender.bfs_recommend('pop', mood='energetic', max_depth=2, limit=5)
...
class TestDFSRecommend:
    ...
    def test_dfs_recommend_genre_only(self, music_recommender):
        ...
        recommendations = music_recommender.dfs_recommend('rock', max_breadth=3, limit=5)
    ...
    def test_dfs_recommend_with_mood(self, music_recommender):
        ...
        recommendations = music_recommender.dfs_recommend('pop', mood='party', max_breadth=3, limit=5)
...
class TestUtilityMethods:
    ...
    def test_search_tracks_by_name(self, music_recommender):
        ...
        found_track = next((r for r in results if 'Song A' in r.get('track_name', '')), None)
